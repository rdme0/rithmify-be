...
import backend.tierlist.domain.*
...
class TierListService(
        ...
        fun getTierList(id: Long): TierListResponse {
                val tierList =
                        tierListRepository.findByIdOrNull(id)
                                ?: throw BusinessException(ErrorCode.TIER_LIST_NOT_FOUND)
        ...
        private fun resolveUser(userId: String?): User {
                return if (userId != null) {
                        ...
                        val guestUser = User(id = guestId, role = UserRole.GUEST)
